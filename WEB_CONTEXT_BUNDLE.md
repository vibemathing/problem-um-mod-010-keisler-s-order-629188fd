...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-mod-010-keisler-s-order-629188fd-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/MOD-010"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-mod-010-keisler-s-order-629188fd-v1",
      "problem_contract_sha256": "aa2cc1d2be54f9279e9adb57c6c658b6dbb65b9e4b2d54e4401c3eeeb76b1bc7",
      "problem_id": "problem:um-mod-010-keisler-s-order-629188fd",
      "route_id": "route:um-mod-010-keisler-s-order-629188fd-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-mod-010-keisler-s-order-629188fd-source-fidelity-01",
      "graph_id": "graph:um-mod-010-keisler-s-order-629188fd-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-mod-010-keisler-s-order-629188fd-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-mod-010-keisler-s-order-629188fd-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Determine the structure of Keisler's order on first-order theories."
          },
          "statement_sha256": "db10c72269b14de86eff46841bcb7da916123d34c405f4b0ad360b847ca19361"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-mod-010-keisler-s-order-629188fd-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-mod-010-keisler-s-order-629188fd-root",
      "route_id": "route:um-mod-010-keisler-s-order-629188fd-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-mod-010-98f97ab16b89",
        "url": "https://www.unsolvedmath.com/problems/MOD-010"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
